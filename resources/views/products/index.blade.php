<html>
    ...
    <body class="p-4">
        ...
        <table class="table-auto w-full mt-5">
            ...
            <tbody>
                ...
                <tr>
                    <td class="border p-2">{{ $p->nama_makeup }}</td>
        ...
        <div id="modal-tambah-item" class="fixed inset-0 bg-black bg-opacity-50 hidden items-center justify-center">
            <div class="bg-white p-6 rounded-2xl shadow-lg w-96">
                ...
                <form id="form-tambah" action="{{ route('products.store') }}" method="post">
                    @csrf
                    <label for="nama_makeup" class="text-sm">Nama Makeup</label>
                    <input type="text" name="nama_makeup" class="w-full border p-2 mb-3 rounde" required>
        ...
        <div id="modal-edit-item" class="fixed inset-0 bg-black bg-opacity-50 hidden items-center justify-center">
            <div class="bg-white p-6 rounded-2xl shadow-lg w-96">
                ...
                <form id="form-edit" action="" method="post">
                    ...
                    @method('PUT')
                    <label for="nama_makeup" class="text-sm">Nama Makeup</label>
                    <input type="text" id="edit_nama_makeup" name="nama_makeup" class="w-full border p-2 mb-3 rounde" required>
                    <label for="harga" class="text-sm">Harga</label>
    ...
    document.getElementById('edit_nama_makeup').value = item.nama_makeup;
